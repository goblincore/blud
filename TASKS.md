...
- [x] 3b **Train carriage kit** ([spec](docs/superpowers/specs/2026-09-25-train-carriage-kit-design.md) · [plan](docs/superpowers/plans/2026-09-25-train-carriage-kit.md)): `kit.blend` (23 pieces, 6 baked textures) → `night-train` carriages 1, 3, 5, 8 (310 linked pieces → 71 instanced meshes), WGSL window scenery, sway; the Void's portal → `night-train`. Gate `scripts/sdf-game-train-gate.sh` passes. **Budget +175 draws / +10 ms PROPOSED, awaiting owner.**
