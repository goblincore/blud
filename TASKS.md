...
- `P8`  [~]  **SDF character language** — WAM-style text format → `BodyDef`, checks on `sdBody()`, turntable, agent skill. Spec fully approved (all sections + 4 open questions resolved); no implementation plan yet.
