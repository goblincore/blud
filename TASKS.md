...
- [~] 4c **Night Train look v2** (owner, after playing): a grimy industrial prison train. Part 1 restyle [spec](docs/superpowers/specs/2026-09-25-night-train-art-v2-design.md) · [plan](docs/superpowers/plans/2026-09-25-night-train-art-v2.md) **built** (kit v2: 54 pieces, 11 materials baked to colour/roughness/normal, art 7.4 MB; 202 instanced meshes). Walk, windows, sway pass; **cost over budget: +229..+332 draws (budget +200), +8.7..+11.4 ms (+10), owner call pending** → part 2 flashlight pickup + dynamic lights (failing lamps, window sweeps, furnaces; **thunderstorm outside, lightning lights the interior**) → part 3 haze + raymarched volumetric light for every light.
