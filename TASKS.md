...
- `X1.27` [ ] **Baked-SDF dynamite grip + underhand release** — six-frame right-hand grip clip, licensed derived GLB bundle, and continuous held→flight handoff during the Blood-style underhand toss. Design approved; implementation plan written/review pending and deliberately not dispatched. [design](docs/superpowers/specs/2026-08-17-sdf-dynamite-grip-release-design.md) · [plan](docs/superpowers/plans/2026-08-17-sdf-dynamite-grip-release.md)
