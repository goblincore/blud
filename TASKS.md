...
- [~] 4c **Night Train look v2** (owner, after playing): a grimy industrial prison train. Part 1 restyle [spec](docs/superpowers/specs/2026-09-25-night-train-art-v2-design.md) approved (**next: plan**) → part 2 flashlight pickup + dynamic lights (failing lamps, window sweeps, furnaces; **thunderstorm outside, lightning lights the interior**) → part 3 haze + raymarched volumetric light for every light.
