...
- `X1.27` [ ] **Baked-SDF dynamite grip + underhand release** — six-frame right-hand grip clip, licensed derived GLB bundle, and continuous held→flight handoff during the Blood-style underhand toss. Design approved; plan/review pending and deliberately not dispatched. [design](docs/superpowers/specs/2026-08-17-sdf-dynamite-grip-release-design.md)
