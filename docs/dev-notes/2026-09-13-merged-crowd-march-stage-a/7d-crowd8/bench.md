...
## INCOMPLETE RUN — 0 leg-run(s) failed, 1 aborted, 1 completed
...
| ---: | --- | ---: | --- | ---: | --- |
| 0 | crowd-on | 1 | frame-cap | n/a | probe evaluate failed after 30 s: CDP Runtime.evaluate (id 31) never answered in 60s — rep0 crowd-on/room1/passes [probe] params: {"expression":"__sdfGame.bench({ room: 1, mode: \"passes\", warmup: 4, |

## Throughput (chunked + fenced) — median chunk-mean ms, median of repeats

| leg | room | spawned | overall | walk | fire | gib | worst chunk |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| baseline | 1 | 1 | 87.91 | 74.20 | 99.99 | 87.92 | 113.34 |
...
| ---: | --- | ---: | ---: | ---: | ---: | ---: |
| 1 | walk | 14→13 | 17→17 | 0→0 | 6→6 | 258→258 |
| 1 | fire | 13→10 | 17→33 | 0→0 | 6→237 | 258→421 |
| 1 | gib | 10→10 | 33→34 | 0→0 | 237→12 | 421→264 |
