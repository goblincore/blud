...
| ---: | --- | ---: | --- | ---: | --- |
| 0 | crowd-on | 1 | frame-cap | n/a | probe evaluate failed after 30 s: CDP Runtime.evaluate (id 33) never answered in 60s — rep0 crowd-on/room1/passes [probe] params: {"expression":"__sdfGame.bench({ room: 1, mode: \"passes\", warmup: 4, |
| 0 | crowd-on-tiles-off | 1 | frame-cap | n/a | probe evaluate failed after 30 s: CDP Runtime.evaluate (id 44) never answered in 60s — rep0 crowd-on-tiles-off/room1/passes [probe] params: {"expression":"__sdfGame.bench({ room: 1, mode: \"passes\",  |

## Throughput (chunked + fenced) — median chunk-mean ms, median of repeats

| leg | room | spawned | overall | walk | fire | gib | worst chunk |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| baseline | 1 | 1 | 38.25 | 112.58 | 36.27 | 31.25 | 123.51 |
...
| ---: | --- | ---: | ---: | ---: | ---: | ---: |
| 1 | walk | 22→19 | 17→17 | 0→0 | 6→6 | 258→258 |
| 1 | fire | 19→5 | 17→33 | 0→0 | 6→128 | 258→348 |
| 1 | gib | 5→5 | 33→33 | 0→0 | 128→3 | 348→257 |
