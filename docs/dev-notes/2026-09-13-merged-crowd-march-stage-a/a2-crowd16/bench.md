...
## INCOMPLETE RUN — 0 leg-run(s) failed, 2 aborted, 1 completed
...
| 0 | crowd-boxes | 1 | frame-cap | n/a | probe evaluate failed after 30 s: CDP Runtime.evaluate (id 46) never answered in 60s — rep0 crowd-boxes/room1/passes [probe] params: {"expression":"__sdfGame.bench({ room: 1, mode: \"passes\", warmup: |

## Throughput (chunked + fenced) — median chunk-mean ms, median of repeats

| leg | room | spawned | overall | walk | fire | gib | worst chunk |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| crowd-quad | 1 | 1 | 137.21 | 121.65 | 175.98 | 137.21 | 206.79 |
...
| ---: | --- | ---: | ---: | ---: | ---: | ---: |
| 1 | walk | 21→20 | 17→17 | 0→0 | 6→7 | 258→259 |
| 1 | fire | 20→19 | 17→33 | 0→0 | 7→229 | 259→413 |
| 1 | gib | 19→17 | 33→35 | 0→1 | 229→70 | 413→285 |
