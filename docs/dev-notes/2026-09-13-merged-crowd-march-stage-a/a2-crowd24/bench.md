...
## INCOMPLETE RUN — 0 leg-run(s) failed, 3 aborted, 0 completed
...
| ---: | --- | ---: | --- | ---: | --- |
| 0 | baseline | 1 | frame-cap | n/a | probe evaluate failed after 30 s: CDP Runtime.evaluate (id 18) never answered in 60s — rep0 baseline/room1/passes [probe] params: {"expression":"__sdfGame.bench({ room: 1, mode: \"passes\", warmup: 4, |
| 0 | crowd-quad | 1 | frame-cap | n/a | probe evaluate failed after 30 s: CDP Runtime.evaluate (id 30) never answered in 60s — rep0 crowd-quad/room1/passes [probe] params: {"expression":"__sdfGame.bench({ room: 1, mode: \"passes\", warmup:  |
| 0 | crowd-boxes | 1 | frame-cap | n/a | probe evaluate failed after 30 s: CDP Runtime.evaluate (id 43) never answered in 60s — rep0 crowd-boxes/room1/passes [probe] params: {"expression":"__sdfGame.bench({ room: 1, mode: \"passes\", warmup: |
