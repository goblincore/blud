...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| baseline | 1 | 1 | 85.83 | 133.97 | 85.83 | 53.39 | 278.57 |
...
| --- | ---: | --- | ---: | ---: |
| baseline | 1 | 84.62 / 157.04 / 85.83 | 72.42 | 86% |

**Worst repeat spread: 86%.** Judge each delta
...
| ---: | --- | ---: | ---: | ---: | ---: | ---: |
| 1 | walk | 24→25 | 0→0 | 0→0 | 0→0 | 0→0 |
| 1 | fire | 25→7 | 0→16 | 0→0 | 0→69 | 0→291 |
| 1 | gib | 7→5 | 16→16 | 0→0 | 69→150 | 291→328 |
