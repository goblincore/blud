...
| goo:density | 0.01 | 0% |
| effects | 0.01 | 0% |
| **labelled total (sum of medians)** | **33.64** | 100% |
| GPU span p50 (first start → last end) | 30.20 |  |
| fenced frame p50 | 31.65 |  |
| gap (frame − span) | 1.45 | 5% of frame |
...
| goo:density | 0.02 | 0% |
| effects | 0.01 | 0% |
| **labelled total (sum of medians)** | **39.68** | 100% |
| GPU span p50 (first start → last end) | 34.74 |  |
| fenced frame p50 | 34.73 |  |
| gap (frame − span) | -0.01 | -0% of frame |
...
| --- | ---: | --- | ---: |
| crowd-off | 1 | 31.65 / 31.47 | 1% |
| crowd-quad | 1 | 34.61 / 34.73 | 0% |
