...
describe('parseIntParam — absent is NOT zero', () => {
  ...
  it('fixes the pre-existing ?tracerlightslots default, which was silently 0', () => {
    ...
    //
    // The shipped default is 2 (it went to 4 for part of 2026-09-10 and came
    // back — the number is not what this test is about; what it is about is that
    // ABSENT yields a real slot count at all, and that an EXPLICIT 0 still
    // switches them off).
