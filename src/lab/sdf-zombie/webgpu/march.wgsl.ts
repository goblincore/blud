...
//   row 20 primStrand   x = strand count, y = wave, z = cycles, w = fat
 ...
 *  Lipschitz argument. */
export const ROW_PRIM_STRAND = 20;
...
// trace (at a step cost; the relax-1.4 render gate on strand-fixture.blob
// is the proof the bound suffices).
