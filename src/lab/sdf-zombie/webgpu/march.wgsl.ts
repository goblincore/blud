...
import { MAX_CROWD_INSTANCES, REC_ANCHOR_BAND, REC_BURN, REC_CENTRE_SEED, REC_COUNTS, REC_COUNTS2, REC_FLASH, REC_GORE, REC_HALF_REV, REC_HEAD_QUAT, REC_HEAD_WCOUNT, REC_MELT, REC_NOISE_YAW, REC_VEC4S, REC_VOL_POSE0, REC_VOL_POSE1, REC_WIND_ALIVE, REC_WOUND_BOUND } from './crowd-records';
...
import { DATA_ROWS, QUAD_ENTRY_SLACK, RAY_CULL_SLACK, ROW_CLUSTER_BOUNDS, ROW_CLUSTER_GROUPS, ROW_CLUSTER_RANGE, ROW_GROUP_BOUNDS, ROW_GROUP_RANGE, ROW_PRIM_B, ROW_PRIM_BEND, ROW_PRIM_CLIP, ROW_PRIM_COLOR, ROW_PRIM_SCALE, ROW_PRIM_SHAPE, ROW_PRIM_SHELL, ROW_PRIM_WARP, ROW_WOUND, ROW_WOUND_FLAGS, ROW_WOUND_META, WOUND_STEP_MUL } from './march/layout';
import { FBM, HASH13, NOISE3, NOISE_LOCAL, Q_FROM_TO, Q_MUL, Q_ROT } from './march/math.wgsl';
import { FACE_MELT_FADE_LO, FACE_MELT_SAG, FACE_MELT_STRETCH, HEAD_EXTERIOR_GORE_KEEP, MELT_SKIN_CONTRAST, MELT_SKIN_KEEP, MELT_SKIN_PATCH_FREQ, MELT_SKIN_PATCH_SOFT } from './march/melt';
